...
module.exports = {
    ...
    createCollaborator: async function (req, res) {
        ...
        return new Promise((resolve, reject) => {
            ...
            .then(() => {
                if (decodedJwtAuthorization.payload.profileId === decodedJwtCollaborate.payload.ownerProfileId) {
                    throw new Error("You can not collaborate yourself")
                }
            })
            .then(() => {
                return Promise
                    .all([
                        ...
                        Token.deleteOne({
                            body: req.headers.collaborate_confirm
                        }).exec()
