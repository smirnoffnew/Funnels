    ...
    constructor(props) {
        ...
        this.onChange = (editorState) => {
            this.setState({ editorState }, () => {
                if (this.props.handleUpdateText) {
                    this.props.handleUpdateText(draftToHtml(convertToRaw(this.state.editorState.getCurrentContent())))
                }
            })
        };
                ...
                <div className={'RichEditor-block-utils'}>
                    ...
                    </div>
                    {
                        ...
                        <button
                            ...
                            // onClick={() => console.log('editorState: ', editorState)}
                            style={{
                                height: 30,
                                width: 100,
