...
export const NotesStatusIconGroup = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="20.531" height="18.297" viewBox="0 0 20.531 18.297">
            <g id="Group_92" data-name="Group 92" transform="translate(-124.5 1238.031) rotate(-90)">
                <g id="Group_71" data-name="Group 71" transform="translate(1232.5 124.5) rotate(90)">
